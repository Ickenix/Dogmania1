/*
  ...
  1. New Tables
    - `dog_vaccinations` - Track dog vaccinations
    - `dog_medications` - Track dog medications
    - `dog_health_records` - Track general health records
    - `dog_weight_history` - Track weight over time
  2. Security
    - Enable RLS on all tables
    - Add policies for authenticated users to manage their own dogs' records
*/
