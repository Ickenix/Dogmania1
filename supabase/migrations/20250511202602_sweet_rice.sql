/*
  ...
  1. New Functions
    ...
    - notify_new_message: Trigger function for new messages
    - notify_booking_status: Trigger function for booking status changes
    - notify_new_comment: Trigger function for new comments
    - notify_new_rating: Trigger function for new ratings
  
  2. Triggers
    - Conditionally create triggers to avoid "already exists" errors
*/
